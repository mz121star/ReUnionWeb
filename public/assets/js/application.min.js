...
function sidebarFluid() {
    $("#left").hasClass("sidebar-fixed") && $("#left").removeClass("sidebar-fixed").css({height: "auto", top: "0", left: "auto"});
...
function slimScrollUpdate(e, t) {
    if (e.length > 0) {
        var n = parseInt(e.attr("data-height")), r = e.attr("data-visible") == "true" ? !0 : !1, i = e.attr("data-start") == "bottom" ? "bottom" : "top", s = {height: n, color: "#666", start: i};
        if (r) {
            s.alwaysVisible = !0;
            s.disabledFadeOut = !0
        }
...
function initSidebarScroll() {
    ...
    if (!$("#left").hasClass("hasScroll")) {
        $("#left").niceScroll({cursorborder: 0, cursorcolor: "#999", railoffset: {top: 0, left: -2}, autohidemode: !1, horizrailenabled: !1});
...
function resizeContent() {
    if ($("#main").height() < $(window).height()) {
        ...
        $("#content").css({"min-height": "auto", height: $(window).height() - e})
    }
    if ($("#left").height() > $("#main").height() && $("#main").height() < $(window).height()) {
        $("#left").addClass("full");
        $("#footer").css({position: "fixed", bottom: 0, top: "auto"})
    }
...
$(document).ready(function () {
    ...
    if ($(".username-check").length > 0) {
        ...
        $(".username-check").change(function (e) {
            ...
            $.post("/check", {username: t.val()}, function (e) {
                if (e.available == "true") {
    ...
    $(".gallery-dynamic").length > 0 && $(".gallery-dynamic").imagesLoaded(function () {
        $(".gallery-dynamic").masonry({itemSelector: "li", columnWidth: 201, isAnimated: !0})
    });
    $(".gototop").click(function (e) {
        e.preventDefault();
        $("html, body").animate({scrollTop: 0}, 600)
    });
    $("body").attr("data-mobile-sidebar") == "slide" && $("body").touchwipe({wipeRight: function () {
    ...
    $(".main-nav > li, .subnav-menu > li").hover(function () {
        if ($(this).attr("data-trigger") == "hover")if ($(this).parents(".subnav-menu").length > 0 && $("#left").hasClass("sidebar-fixed"))$(this).find(">a").trigger("click"); else {
    ...
    $(".subnav-menu > li > a[data-toggle=dropdown]").click(function () {
        ...
        if ($("#left").hasClass("sidebar-fixed") || $("#left").hasClass("mobile-show")) {
            $(".cloned").remove();
            var t = e.next(), n = e.offset(), r = t.clone().css({top: n.top, left: n.left + $("#left").width()}).show().addClass("cloned");
            $("body").append(r);
            t.hide();
    ...
    $(".content-remove").click(function (e) {
        ...
        bootbox.confirm("Do you really want to remove the widget <strong>" + t.parents(".box-title").find("h3").text() + "</strong>?", "Cancel", "Yes, remove", function (e) {
            if (e)if ($(".container-fluid").hasClass("sortable-box"))t.parents(".box").remove(); else {
    ...
    $("#vmap").length > 0 && $("#vmap").vectorMap({map: "world_en", backgroundColor: null, color: "#ffffff", hoverOpacity: .7, selectedColor: "#2d91ef", enableZoom: !0, showTooltip: !1, values: sample_data, scaleColors: ["#8cc3f6", "#5c86ac"], normalizeFunction: "polynomial", onRegionClick: function () {
    ...
    if ($("#new-task .select2-me").length > 0) {
        ...
        $("#new-task .select2-me").select2({formatResult: t, formatSelection: t, escapeMarkup: function (e) {
            return e
        }})
    }
    ...
    $(".tasklist").sortable({items: "li", opacity: .7, placeholder: "widget-placeholder-2", forcePlaceholderSize: !0, tolerance: "pointer"});
    $(".sortable-box").sortable({connectWith: ".box", items: ".box", opacity: .7, placeholder: "widget-placeholder", forcePlaceholderSize: !0, tolerance: "pointer", dropOnEmpty: !0});
    ...
    $("#left").sortable({items: ".subnav", placeholder: "widget-placeholder", forcePlaceholderSize: !0, axis: "y", handle: ".subnav-title", tolerance: "pointer"});
    $(".scrollable").length > 0 && $(".scrollable").each(function () {
        var e = $(this), t = parseInt(e.attr("data-height")), n = e.attr("data-visible") == "true" ? !0 : !1, r = e.attr("data-start") == "bottom" ? "bottom" : "top", i = {height: t, color: "#666", start: r, allowPageScroll: !0};
        if (n) {
            i.alwaysVisible = !0;
            i.disabledFadeOut = !0
        }
    ...
    $(".jq-datepicker").length > 0 && $(".jq-datepicker").datepicker({showOtherMonths: !0, selectOtherMonths: !0, prevText: "", nextText: ""});
    $(".spark-me").length > 0 && $(".spark-me").sparkline("html", {height: "25px", enableTagOptions: !0});
    $("#left").hasClass("no-resize") || $("#left").resizable({minWidth: 60, handles: "e", resize: function (e, t) {
        var n = $(".search-form .search-pane input[type=text]"), r = $("#main");
        n.css({width: t.size.width - 55});
...
$(window).scroll(function (e) {
    ...
    if (n.scrollTop() == 0 || $("#left").hasClass("sidebar-fixed"))$("#left .ui-resizable-handle").css("top", t); else {
